...
// in simulator we redefine to format for Trainer Developer console
...
{\
	NSString * exceptionName = [@"org.trainer." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.trainer";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITrainerNativeItemNone = -1, 
	UITrainerNativeItemSpinner = -2,
	UITrainerNativeItemProgressBar = -3,
	
	UITrainerNativeItemSlider = -4,
	UITrainerNativeItemSwitch = -5,
	UITrainerNativeItemMultiButton = -6,
	UITrainerNativeItemSegmented = -7,
	
	UITrainerNativeItemTextView = -8,
	UITrainerNativeItemTextField = -9,
	UITrainerNativeItemSearchBar = -10,
	
	UITrainerNativeItemPicker = -11,
	UITrainerNativeItemDatePicker = -12,
	
	UITrainerNativeItemInfoLight = -13,
	UITrainerNativeItemInfoDark = -14,
	
	UITrainerNativeItemDisclosure = -15,
	
	UITrainerNativeItemContactAdd = -16
};
