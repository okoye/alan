...
//@interface TrainerObject : NSObject
//@end

@interface TrainerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TrainerObject class]])
		{
			for (NSString *key in [[(TrainerObject*)o modules] allKeys])
			{
